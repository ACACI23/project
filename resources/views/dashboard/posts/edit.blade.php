...
<div class="mb-3">
    ...
    oFReader.readAsDataURL(image.files[0]); // Perbaikan: Mengganti image.fiels[0] menjadi image.files[0]

    oFReader.onload = function (oFREvent) { // Perbaikan: Mengganti oFReader menjadi oFREvent
